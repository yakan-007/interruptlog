...
function createPassthroughActions({ app, closeSheet }) {
  ...
  return {
    ...
    previewReplaceTimeRange: app.actions.previewReplaceTimeRange,
    replaceTimeRange: app.actions.replaceTimeRange,
    restoreTimelineSnapshot: app.actions.restoreTimelineSnapshot,
